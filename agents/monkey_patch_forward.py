# https://github.com/2U1/Qwen2-VL-Finetune/blob/567a625dbd49e35321fa3246c1bced08a03b5cc1/src/training/monkey_patch_forward.py
...
def replace_qwen2_5_with_mixed_modality_forward():
    ...
    transformers.models.qwen2_5_vl.modeling_qwen2_5_vl.apply_rotary_pos_emb_flashatt = (
        apply_rotary_pos_emb_flashatt_fp32
    )
